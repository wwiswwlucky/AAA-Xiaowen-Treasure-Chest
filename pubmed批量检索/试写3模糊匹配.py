...
def extract_sentences(text, keywords):
    ...
    return [s for s in sentences if any(k in s.lower() for k in lowercase_keywords)]

# ✅ PubMed 查询函数：支持模糊匹配和大小写不敏感
def query_pubmed(term1, term2, max_results=10):
    # 疾病模糊匹配，term1后加*（PubMed 支持通配符）
...
output_excel = r"D:\Desktop\实验1_结果输出无匹配.xlsx"
